          ...
          <div class="desc">
            <div class="icons">
              <div class="icon_left d-flex">
                <div class="like">
                  <button class="like-button" data-post-id="${ post.id }" style="background: none; border: none; padding: 0; color: black;">
                    <svg aria-label="Like" class="not_loved" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24" data-post-id="${ post.id }" style="display: ${post.is_liked ? 'none' : 'inline'};">
                      <title>Like</title>
                    ...
                    <svg aria-label="Unlike" class="loved" fill="currentColor" height="24" role="img" viewBox="0 0 48 48" width="24" data-post-id="${ post.id }" style="display: ${post.is_liked ? 'inline' : 'none'}; color:red;">
                      <title>Unlike</title>
      ...
      .then((profile_data) => {
        ...
        profileContainer.innerHTML = `
          <div class="profile_info">
              <div class="cart">
                      ...
                      <div class="info">
                          ...
                          <p class="nick_name">${profile.full_name}</p>
                          <p class="desc">
                              ${profile.bio} <br>
                              This is just a instagram clone.
                          </p>
                      </div>
              </div>
          </div>
          <div class="highlights">
              <div class="highlight">
                  <div class="img">
                      <img src="https://i.pinimg.com/736x/18/d6/6f/18d66f6df9b5977afa1a7c2d4506bd2e.jpg" alt="">
                  </div>
                  <p>conseils</p>
              </div>
                ...
                <div class="media-container">
                  ...
                  <div class="bg">
                    <div class="info">
                      ...
                      <div class="comments">
                        <span>comments ${item.image.comment_count || 0}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="media-container">
                  ...
                  <div class="bg">
                    <div class="info">
                      ...
                      <div class="comments">
                        <span>💬 ${item.image.comment_count || 0}</span>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    try {
        const response = await fetch('/api/reels/', {
            ...
            headers: {
                ...
                'Authorization': `Bearer ${localStorage.getItem('accessToken')}` // Use this if you have JWT auth
            }
        });
              ...
              <div class="content">
                  ...
                  <div class="info">
                      ...
                      <div class="desc">
                          ...
                          <div class="more">
                              <div class="music">music <span>${reel.music || 'Original Music'}</span></div>
